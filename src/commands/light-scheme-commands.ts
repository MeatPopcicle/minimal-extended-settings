...
export function registerLightSchemeCommands(plugin: MinimalTheme) {
  ...
  plugin.addCommand({
    id: 'toggle-minimal-tokyo-night-day',
    name: 'Switch light color scheme to Tokyo Night Day (light)',
    callback: () => {
      plugin.settings.lightScheme = 'minimal-tokyo-night-day';
      plugin.saveData(plugin.settings);
      plugin.updateLightScheme();
      plugin.updateLightStyle();
    }
  ...
  plugin.addCommand({
    id: 'toggle-minimal-oxo-carbon-light',
    name: 'Switch light color scheme to OXO Carbon (light)',
    callback: () => {
      plugin.settings.lightScheme = 'minimal-oxo-carbon-light';
      plugin.saveData(plugin.settings);
      plugin.updateLightScheme();
      plugin.updateLightStyle();
    }
