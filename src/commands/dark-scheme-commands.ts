...
export function registerDarkSchemeCommands(plugin: MinimalTheme) {
  ...
  plugin.addCommand({
    id: 'toggle-minimal-tokyo-night-night',
    name: 'Switch dark color scheme to Tokyo Night (dark)',
    callback: () => {
      plugin.settings.darkScheme = 'minimal-tokyo-night-night';
      plugin.saveData(plugin.settings);
      plugin.updateDarkScheme();
      plugin.updateDarkStyle();
    }
  ...
  plugin.addCommand({
    id: 'toggle-minimal-tokyo-night-storm',
    name: 'Switch dark color scheme to Tokyo Night Storm (dark)',
    callback: () => {
      plugin.settings.darkScheme = 'minimal-tokyo-night-storm';
      plugin.saveData(plugin.settings);
      plugin.updateDarkScheme();
      plugin.updateDarkStyle();
    }
  ...
  plugin.addCommand({
    id: 'toggle-minimal-monokai-classic',
    name: 'Switch dark color scheme to Monokai Classic (dark)',
    callback: () => {
      plugin.settings.darkScheme = 'minimal-monokai-classic';
      plugin.saveData(plugin.settings);
      plugin.updateDarkScheme();
      plugin.updateDarkStyle();
    }
  ...
  plugin.addCommand({
    id: 'toggle-minimal-monokai-pro',
    name: 'Switch dark color scheme to Monokai Pro (dark)',
    callback: () => {
      plugin.settings.darkScheme = 'minimal-monokai-pro';
      plugin.saveData(plugin.settings);
      plugin.updateDarkScheme();
      plugin.updateDarkStyle();
    }
  ...
  plugin.addCommand({
    id: 'toggle-minimal-oxo-carbon-dark',
    name: 'Switch dark color scheme to OXO Carbon (dark)',
    callback: () => {
      plugin.settings.darkScheme = 'minimal-oxo-carbon-dark';
      plugin.saveData(plugin.settings);
      plugin.updateDarkScheme();
      plugin.updateDarkStyle();
    }
